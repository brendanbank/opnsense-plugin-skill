...
- A `build.sh` script in your plugin repo (see [metrics-exporter](https://github.com/brendanbank/opnsense-metrics-exporter) or [kea-ddns](https://github.com/brendanbank/opnsense-kea-ddns) for examples)
